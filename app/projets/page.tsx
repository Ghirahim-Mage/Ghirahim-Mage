    ...
    <div className="cardWrapper">
      <div className="cardProject">
        <div className="imgProject">
          <img src="/img/project/flatcraft.webp" alt="project"/>
        </div>
      ...
      <div className="cardProject">
        <div className="imgProject">
          <img src="/img/project/ray-tracing.webp" alt="project"/>
        </div>
        <div className="textSkill">
      ...
      <div className="cardProject">
        <div className="imgProject">
          <img src="/img/project/jo.webp" alt="project"/>
        </div>
        <div className="textSkill">
      ...
      <div className="cardProject">
        <div className="imgProject">
          <img src="/img/project/marathon.webp" alt="project"/>
        </div>
        <div className="textSkill">
